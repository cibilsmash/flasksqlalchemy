...
def insertemployee():
    if request.method == 'POST':
        ...
        my_data = Employee(birth_date=birth_date, first_name=first_name,
...
def insertdepartmentemployee():
    if request.method == 'POST':
        ...
        my_depemp = DepartmentEmployee(
            emp_no=emp_no, dep_no=dep_no, from_date=from_date, to_date=to_date)
...
def insertsalary():
    if request.method == 'POST':
        ...
        from_date = request.form['from_date']
        to_date = request.form['to_date']
        ins_salary = Salary(emp_no=emp_no, salary=salary,
...
def inserttitle():
    if request.method == 'POST':
        ...
        from_date = request.form['from_date']
        to_date = request.form['to_date']
        ins_title = Title(emp_no=emp_no, title=title,
                          from_date=from_date, to_date=to_date)
